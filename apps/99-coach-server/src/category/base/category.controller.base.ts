...
import { GigFindManyArgs } from "../../gig/base/GigFindManyArgs";
import { Gig } from "../../gig/base/Gig";
...
export class CategoryControllerBase {
  ...
  async findGigs(
    ...
    const query = plainToClass(GigFindManyArgs, request.query);
    const results = await this.service.findGigs(params.id, {
      ...query,
      select: {
        category: {
          select: {
  ...
  async connectGigs(
    @common.Param() params: CategoryWhereUniqueInput,
    @common.Body() body: GigWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      gigs: {
        connect: body,
  ...
  @common.Delete("/:id/gigs")
  @nestAccessControl.UseRoles({
    resource: "Category",
    action: "update",
    possession: "any",
  })
  async disconnectGigs(
    @common.Param() params: CategoryWhereUniqueInput,
    @common.Body() body: GigWhereUniqueInput[]
  ): Promise<void> {
    const data = {
