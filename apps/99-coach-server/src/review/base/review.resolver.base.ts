...
export class ReviewResolverBase {
  ...
  async getGig(@graphql.Parent() parent: Review): Promise<Gig | null> {
    const result = await this.service.getGig(parent.id);
