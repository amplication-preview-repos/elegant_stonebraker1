...
class GigUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => OrderUpdateManyWithoutGigsInput,
  })
  @ValidateNested()
  @Type(() => OrderUpdateManyWithoutGigsInput)
  @IsOptional()
  @Field(() => OrderUpdateManyWithoutGigsInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => ReviewUpdateManyWithoutGigsInput,
  })
  @ValidateNested()
  @Type(() => ReviewUpdateManyWithoutGigsInput)
  @IsOptional()
  @Field(() => ReviewUpdateManyWithoutGigsInput, {
    nullable: true,
  })
...
export { GigUpdateInput as GigUpdateInput };
