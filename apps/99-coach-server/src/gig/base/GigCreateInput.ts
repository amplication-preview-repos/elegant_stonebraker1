...
class GigCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => OrderCreateNestedManyWithoutGigsInput,
  })
  @ValidateNested()
  @Type(() => OrderCreateNestedManyWithoutGigsInput)
  @IsOptional()
  @Field(() => OrderCreateNestedManyWithoutGigsInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => ReviewCreateNestedManyWithoutGigsInput,
  })
  @ValidateNested()
  @Type(() => ReviewCreateNestedManyWithoutGigsInput)
  @IsOptional()
  @Field(() => ReviewCreateNestedManyWithoutGigsInput, {
    nullable: true,
  })
...
export { GigCreateInput as GigCreateInput };
